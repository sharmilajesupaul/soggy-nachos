...
function mdMediaFactory(e, t, n) {
  function r(e) {
    var t = d[e];
    angular.isUndefined(t) && (t = d[e] = o(e));
    var n = c[t];
  ...
  function a(e) {
    var t = n.matchMedia(e);
    return t.addListener(i), c[t.media] = !!t.matches
  }
...
angular.module("ngMaterial", ["ng", "ngAnimate", "ngAria", "material.core", "material.core.theming.palette", "material.core.theming", "material.components.backdrop", "material.components.bottomSheet", "material.components.button", "material.components.card", "material.components.checkbox", "material.components.content", "material.components.dialog", "material.components.divider", "material.components.icon", "material.components.input", "material.components.list", "material.components.progressCircular", "material.components.progressLinear", "material.components.radioButton", "material.components.sidenav", "material.components.slider", "material.components.sticky", "material.components.subheader", "material.components.swipe", "material.components.switch", "material.components.tabs", "material.components.textField", "material.components.toast", "material.components.toolbar", "material.components.tooltip", "material.components.whiteframe"]),
  ...
  function() {
    function e(e, t) {
      ...
      function l(e, t) {
        return e ? (angular.isNumber(t) || (t = b.length), b.splice(t, 0, e), s(e)) : -1
      }
      ...
      function h(e, n, r, a) {
        ...
        var d = i + (e ? -1 : 1),
          c = null;
        return o(d) ? c = b[d] : t && (c = e ? p() : f(), d = s(c)), null === c || d === a ? null : (angular.isUndefined(a) && (a = d), r(c) ? c : h(e, c, r, a))
      }
      var g = function() {
        return !0
      };
  ...
  function() {
    "use strict";
    var e = ["0", "0", "0"];
    angular.module("material.core").factory("$mdUtil", ["$document", "$timeout", function(t, n) {
      var r;
      return r = {
    ...
    function e(e, t, n) {
      ...
      function i(e, t) {
        ...
        var o = e.hasChildNodes(),
          a = !1;
        if (o)
          for (var i = e.childNodes, d = 0; d < i.length; d++) {
            var c = i[d];
            1 === c.nodeType && c.hasAttribute(t) && (r(c) || (a = !0))
          }
        return a
      }
      return {
    ...
    function e(e, t, n, r, o, a) {
      this.compile = function(i) {
        var d = i.templateUrl,
          ...
          s = i.resolve || {},
          u = i.locals || {},
          f = i.transformTemplate || angular.identity,
          p = i.bindToController;
        return angular.forEach(s, function(e, t) {
          s[t] = angular.isString(e) ? n.get(e) : n.invoke(e)
        }), angular.extend(s, u), s.$template = d ? t.get(d, {
          cache: a
        }).then(function(e) {
          return e.data
        }) : e.when(c), e.all(s).then(function(e) {
          var t = f(e.$template),
            n = angular.element("<div>").html(t.trim()).contents(),
            a = r(n);
          return {
            locals: e,
            element: n,
  ...
  function() {
    ...
    function e(e, t) {
      var n;
      for (var r in c) n = c[r], "start" === e && n.cancel(), n[e](t, g)
    }

    function t(t) {
      if (!g) {
        var n = +Date.now();
        b && !o(t, b) && n - b.endTime < 1500 || (g = d(t), e("start", t))
      }
    }
    ...
    var c, l = "mousedown touchstart pointerdown",
      m = "mousemove touchmove pointermove",
      s = "mouseup mouseleave touchend touchcancel pointerup pointercancel";
    ...
    }, !0), angular.element(document).on(l, t).on(m, n).on(s, r).on("$$mdGestureReset", function() {
      b = g = null
    });
    var g, b;
    angular.module("material.core").run(["$mdGesture", function() {}]).factory("$mdGesture", ["$$MdGestureHandler", "$$rAF", "$timeout", function(e, t, n) {
      function r(t, n) {
        var r = new e(t);
        return angular.extend(r, n), c[t] = r, a
      }

      function o(e, t, n) {
        var r = c[t.replace(/^\$md./, "")];
        if (!r) throw new Error("Failed to register element with handler " + t + ". Available handlers: " + Object.keys(c).join(", "));
      ...
      c = {}, h && r("click", {
        ...
        onEnd: function(e, t) {
          t.distance < this.state.options.maxDistance && this.dispatchEvent(e, "click", null, e)
        }
      }), r("press", {
        onStart: function(e) {
        ...
        onMove: function(e, t) {
          var n, r;
          e.preventDefault(), this.state.dragPointer ? this.dispatchDragMove(e) : (this.state.options.horizontal ? (n = Math.abs(t.distanceX) > this.state.options.minDistance, r = Math.abs(t.distanceY) > 1.5 * this.state.options.minDistance) : (n = Math.abs(t.distanceY) > this.state.options.minDistance, r = Math.abs(t.distanceX) > 1.5 * this.state.options.minDistance), n ? (this.state.dragPointer = d(e), i(e, this.state.dragPointer), this.dispatchEvent(e, "$md.dragstart", this.state.dragPointer)) : r && this.cancel())
        },
  ...
  function() {
    ...
    function e() {
      function e(e) {
        ...
        function r(t, n, r) {
          function o(e) {
            return e && e._options && (e = e._options), l.show(angular.extend({}, c, e))
          }
          ...
          return d = a.methods || [], c = i(a.optionsFactory, {}), angular.forEach(a.presets, function(e, t) {
            function n(e) {
        ...
        return i.addPreset("build", {
          methods: ["controller", "controllerAs", "resolve", "template", "templateUrl", "themable", "transformTemplate", "parent"]
        }), r.$inject = ["$$interimElement", "$animate", "$injector"], i
      }

      function t(e, t, n, r, o, a, i, d, c) {
        function l(e) {
          return e && angular.isString(e) ? e.replace(/\{\{/g, m).replace(/}}/g, s) : e
        }
        var m = i.startSymbol(),
          s = i.endSymbol(),
          u = "{{" === m && "}}" === s,
        ...
        return function() {
          ...
          function s(i) {
            ...
            return i = i || {}, i = angular.extend({
              ...
              deferred: t.defer(),
              show: function() {
                return d.compile(i).then(function(n) {
                  function a() {
                    i.hideDelay && (m = r(u.cancel, i.hideDelay))
                  }
                  angular.extend(n.locals, l.options), angular.isString(i.parent) ? i.parent = angular.element(e[0].querySelector(i.parent)) : i.parent || (i.parent = o.find("body"), i.parent.length || (i.parent = o)), s = n.link(i.scope), i.themable && c(s);
                  var d = i.onShow(i.scope, s, i);
                  return t.when(d).then(function() {
                    (i.onComplete || angular.noop)(i.scope, s, i), a()
                  })
                })
              },
  ...
  function() {
    ...
    function t(e, t) {
      ...
      function a(n, r, o) {
        ...
        function l(n, d) {
          ...
          function m(e, t) {
            var n, r, a, i = u.prop("offsetWidth"),
              d = u.prop("offsetHeight");
            return o.isMenuItem ? r = Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2)) : o.outline ? (a = M.getBoundingClientRect(), e -= a.left, t -= a.top, i = Math.max(e, i - e), d = Math.max(t, d - t), r = 2 * Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2))) : (n = o.isFAB ? 1.1 : .8, r = Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2)) * n, o.fitRipple && (r = Math.min(d, i, r))), r
          }
          ...
          return f = p, A.animating = !0, t(function() {
            o.dimBackground && u.css({
              backgroundColor: T
            }), v.addClass("md-ripple-placed md-ripple-scaled"), o.outline ? v.css({
              borderWidth: .5 * p + "px",
              marginLeft: p * -.5 + "px",
              marginTop: p * -.5 + "px"
            }) : v.css({
        ...
        var f, p = r.controller("mdInkRipple") || {},
          h = 0,
          g = [],
          b = [],
          E = r.attr("md-highlight"),
          v = !1,
          $ = !1,
          M = r[0],
        ...
        return o.mousedown && r.on("$md.pressdown", m).on("$md.pressup", s), p.createRipple = l, E && n.$watch(E, function(e) {
            v = e, v && !g.length && t(function() {
              l(0, 0)
            }, 0, !1), angular.forEach(g, c)
          }),
          function() {
            r.off("$md.pressdown", m).off("$md.pressup", s), a().remove()
          }
      }
      return {
  ...
  function() {
    ...
    function e(e) {
      function t(e, t) {
        return t = t || {}, c[e] = o(e, t), m
      }

      function n(e, t) {
        return o(e, angular.extend({}, c[e] || {}, t))
      }
      ...
      function s(e, t) {
        ...
        return r.inherit = function(r, o) {
          ...
          var i = o.controller("mdTheme"),
            d = r.attr("md-theme-watch");
          if ((b || angular.isDefined(d)) && "false" != d) {
            var c = e.$watch(function() {
      ...
      var g = "default",
        b = !1;
      return angular.extend(c, e), s.$inject = ["$rootScope", "$log"], m = {
        definePalette: t,
        extendPalette: n,
        theme: a,
    ...
    function r(e, t, n) {
      ...
      return n = n.replace(m, function(t, n, r, o) {
        return "foreground" === n ? "shadow" == r ? e.foregroundShadow : e.foregroundPalette[r] || e.foregroundPalette["1"] : (0 === r.indexOf("hue") && (r = e.colors[n].hues[r]), d((c[e.colors[n].name][r] || "").value, o))
      }), angular.forEach(o.hues, function(t, o) {
        var a = n.replace(l, function(e, n, r, o, a) {
          return d(s[t]["color" === o ? "value" : "contrast"], a)
        });
    ...
    function o(e) {
      function t(e) {
        ...
        "string" == typeof n && (n = n.split(" ")), "string" == typeof r && (r = r.split(" ")), "string" == typeof o && (o = o.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastStrongLightColors, delete e.contrastDarkColors, angular.forEach(e, function(a, d) {
          function c() {
            return "light" === t ? o.indexOf(d) > -1 ? g : r.indexOf(d) > -1 ? E : b : n.indexOf(d) > -1 ? r.indexOf(d) > -1 ? E : b : g
          }
      ...
      var d = new RegExp("md-(" + v.join("|") + ")", "g");
      o.forEach(function(e) {
        for (var t, n = (e.match(d), 0); t = v[n]; n++)
      ...
      if (angular.forEach(l, function(e) {
        ...
        f.insertBefore(u, f.firstElementChild), s = !0
      }
    }

    function a(e, t) {
      if (!c[(e.colors[t] || {}).name]) throw new Error("You supplied an invalid color palette for theme %1's %2 palette. Available palettes: %3".replace("%1", e.name).replace("%2", t).replace("%3", Object.keys(c).join(", ")))
    }
  ...
  function() {
    ...
    function t(e) {
      function t(e, t, o, a, i, d, c, l, m, s) {
        function u(n, r, a) {
          h = i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(n), h.on("click", function() {
            o(c.cancel)
          }), d.inherit(h, a.parent), e.enter(h, a.parent, null);
          var m = new p(r, a.parent);
          return a.bottomSheet = m, a.targetEvent && angular.element(a.targetEvent.target).blur(), d.inherit(m.element, a.parent), a.disableParentScroll && (a.lastOverflow = a.parent.css("overflow"), a.parent.css("overflow", "hidden")), e.enter(m.element, a.parent).then(function() {
            ...
            e.focus(), a.escapeToClose && (a.rootElementKeyupCallback = function(e) {
              e.keyCode === t.KEY_CODE.ESCAPE && o(c.cancel)
        ...
        function p(e, a) {
          ...
          function l(r) {
            if (r.pointer.distanceY > 0 && (r.pointer.distanceY > 20 || Math.abs(r.pointer.velocityY) > n)) {
              ...
              e.css(t.CSS.TRANSITION_DURATION, i + "ms"), o(c.cancel)
            } else e.css(t.CSS.TRANSITION_DURATION, ""), e.css(t.CSS.TRANSFORM, "")
          }
          var m = s.register(a, "drag", {
            horizontal: !1
          });
          return a.on("$md.dragstart", i).on("$md.drag", d).on("$md.dragend", l), {
            element: e,
            cleanup: function() {
              m(), a.off("$md.dragstart", i).off("$md.drag", d).off("$md.dragend", l)
            }
          }
        }
        var h;
  ...
  function() {
    ...
    function e(e, t, n) {
      ...
      function a(o, a, i) {
        ...
        var c = d.textContent.trim();
        c || n.expect(a, "aria-label"), r(i) && angular.isDefined(i.ngDisabled) && o.$watch(i.ngDisabled, function(e) {
      ...
      function i(t, i) {
        return i.type = "checkbox", i.tabIndex = 0, t.attr("role", i.type),
          function(t, i, c, l) {
            ...
            function u() {
              f = l.$viewValue, f ? i.addClass(d) : i.removeClass(d)
            }
            l = l || a.fakeNgModel();
            var f = !1;
            o(i), n.expectWithText(i, "aria-label"), e.link.pre(t, {
              on: angular.noop,
              0: {}
            }, c, [l]), i.on("click", s).on("keypress", m), l.$render = u
          }
      }
      e = e[0];
      var d = "md-checked";
  ...
  function() {
    ...
    function t(e) {
      ...
      function n(e, t, n, r, o, a, i, d, c, l, m, s) {
        function u(n, o, a) {
          function i() {
          ...
          var l = i();
          if (p(o.find("md-dialog")), a.hasBackdrop) {
            var m = a.parent.prop("scrollTop");
            a.backdrop = angular.element('<md-backdrop class="md-dialog-backdrop md-opaque">'), c.inherit(a.backdrop, a.parent), r.enter(a.backdrop, a.parent), o.css("top", m + "px")
          }
          return a.disableParentScroll && (a.lastOverflow = a.parent.css("overflow"), a.parent.css("overflow", "hidden")), h(o, a.parent, a.popInTarget && a.popInTarget.length && a.popInTarget).then(function() {
            a.escapeToClose && (a.rootElementKeyupCallback = function(t) {
              t.keyCode === d.KEY_CODE.ESCAPE && e(s.cancel)
            }, t.on("keyup", a.rootElementKeyupCallback)), a.clickOutsideToClose && (a.dialogClickOutsideCallback = function(t) {
              t.target === o[0] && e(s.cancel)
        ...
        function h(e, t, n) {
          ...
          return t.append(e), b(r, n), l(function() {
            r.addClass("transition-in").css(d.CSS.TRANSFORM, "")
          }), E(r)
        }
        ...
        function b(e, t) {
          if (t) {
            ...
            e.css(d.CSS.TRANSFORM, "translate3d(" + (-r.left + n.left + n.width / 2 - r.width / 2) + "px," + (-r.top + n.top + n.height / 2 - r.height / 2) + "px,0) scale(" + o + "," + a + ")")
          }
        }

        function E(e) {
          function t(r) {
            r.target === e[0] && (e.off(d.CSS.TRANSITIONEND, t), n.resolve())
          }
          var n = m.defer();
          return e.on(d.CSS.TRANSITIONEND, t), n.promise
        }
        return {
          hasBackdrop: !0,
          isolateScope: !0,
  ...
  function() {
    ...
    function n(e, t) {
      function n(n, r, o, a) {
        function i(e) {
          return l.setHasValue(!m.$isEmpty(e)), e
        }
        ...
        function c() {
          ...
          var d = r[0],
            c = e.debounce(a, 1);
          m ? (m.$formatters.push(o), m.$viewChangeListeners.push(o)) : c(), r.on("keydown input", c), r.on("scroll", i), angular.element(t).on("resize", c), n.$on("$destroy", function() {
            angular.element(t).off("resize", c)
          })
        }
        var l = a[0],
          m = a[1] || e.fakeNgModel(),
          s = angular.isDefined(o.readonly);
        if (l) {
          if (l.input) throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");
          l.input = r, r.addClass("md-input"), r.attr("id") || r.attr("id", "input_" + e.nextUid()), "textarea" === r[0].tagName.toLowerCase() && c();
          var u = l.isErrorGetter || function() {
            return m.$invalid && m.$touched
          };
          n.$watch(u, l.setInvalid), m.$parsers.push(i), m.$formatters.push(i), r.on("input", d), s || r.on("focus", function() {
            l.setFocused(!0)
          }).on("blur", function() {
            l.setFocused(!1), d()
    ...
    function r(e) {
      function t(t, n, r, o) {
        ...
        r.$set("ngTrim", "false"), c.element.append(l), d.$formatters.push(a), d.$viewChangeListeners.push(a), n.on("input keydown", function() {
          a()
        }), t.$watch(r.mdMaxlength, function(t) {
          i = t, angular.isNumber(t) && t > 0 ? (l.parent().length || e.enter(l, c.element, angular.element(c.element[0].lastElementChild)), a()) : e.leave(l)
    ...
    angular.module("material.components.input", ["material.core"]).directive("mdInputContainer", e).directive("label", t).directive("input", n).directive("textarea", n).directive("mdMaxlength", r).directive("placeholder", o), e.$inject = ["$mdTheming", "$parse"], n.$inject = ["$mdUtil", "$window", "$compile", "$animate"], r.$inject = ["$animate"]
  }(),
  /*!
   * Angular Material Design
   * https://github.com/angular/material
    ...
    function e(e, t, n) {
      ...
      function o(e, r, o) {
        ...
        u.style[t.CSS.TRANSFORM] = "scale(" + g.toString() + ")", o.$observe("value", function(e) {
          for (l = a(e), m = i[l], s = d[l], r.attr("aria-valuenow", l), c = 0; c < f.length; c++) f[c].style[t.CSS.TRANSFORM] = m;
          for (c = 0; c < p.length; c++) p[c].style[t.CSS.TRANSFORM] = s
        })
      }
      ...
      for (var i = new Array(101), d = new Array(101), c = 0; 101 > c; c++) {
        var l = c / 100,
          m = Math.floor(180 * l);
        i[c] = "rotate(" + m.toString() + "deg)", d[c] = "rotate(" + (2 * m).toString() + "deg)"
      }
      return {
        restrict: "E",
  ...
  function() {
    ...
    function e(e, n, r) {
      ...
      function a(o, a, d) {
        r(a);
        var c = a[0].querySelector(".md-bar1").style,
          l = a[0].querySelector(".md-bar2").style,
          m = angular.element(a[0].querySelector(".md-container"));
        d.$observe("value", function(e) {
          if ("query" != d.mdMode) {
            var r = i(e);
            a.attr("aria-valuenow", r), l[n.CSS.TRANSFORM] = t[r]
          }
        }), d.$observe("mdBufferValue", function(e) {
          c[n.CSS.TRANSFORM] = t[i(e)]
        }), e(function() {
          m.addClass("md-ready")
        })
      }
        ...
        function d(n) {
          switch (n.keyCode) {
            ...
            case t.KEY_CODE.UP_ARROW:
              n.preventDefault(), c.selectPrevious();
              break;
            case t.KEY_CODE.RIGHT_ARROW:
            case t.KEY_CODE.DOWN_ARROW:
              n.preventDefault(), c.selectNext();
              break;
      ...
      function r(r, a, i, d) {
        function c(e) {
          a[0].hasAttribute("disabled") || r.$apply(function() {
            d.setViewValue(i.value, e && e.type)
          })
        }

        function l() {
          var e = d.getViewValue() == i.value;
          e !== s && (s = e, a.attr("aria-checked", e), e ? (a.addClass(o), d.setActiveDescendant(a.attr("id"))) : a.removeClass(o))
        }
        ...
        var s;
        n(a), m(a, r), d.add(l), i.$observe("value", l), a.on("click", c).on("$destroy", function() {
          d.remove(l)
        })
      }
      var o = "md-checked";
  ...
  function() {
    ...
    function t(e, t, n, r, o, a, i, d, c) {
      function l(l, m, s, u) {
        function f(e, n) {
          l.isLockedOpen = e, e === n ? m.toggleClass("md-locked-open", !!e) : t[e ? "addClass" : "removeClass"](m, "md-locked-open"), A.toggleClass("md-locked-open", !!e)
        }

        function p(e) {
          var n = m.parent();
          return n[e ? "on" : "off"]("keydown", g), A[e ? "on" : "off"]("click", b), e && (E = c[0].activeElement), v = d.all([t[e ? "enter" : "leave"](A, n), t[e ? "removeClass" : "addClass"](m, "md-closed").then(function() {
            l.isOpen && m.focus()
          })])
        }

        function h(t) {
          if (l.isOpen == t) return d.when(!0);
          var n = d.defer();
        ...
        m.on("$destroy", u.destroy), i.inherit(A, m), l.$watch(M, f), l.$watch("isOpen", p), u.$toggleOpen = h
      }
      return {
        restrict: "E",
        scope: {
  ...
  function() {
    ...
    function e(e, t, n, r, o, a, i, d) {
      function c(c, l, m, s) {
        ...
        function p(e) {
          X = parseFloat(e), l.attr("aria-valuemax", e), u()
        }
        ...
        function b() {
          if (angular.isDefined(m.mdDiscrete)) {
            var e = Math.floor((X - W) / z);
            if (!Z) {
              var n = t.getComputedStyle(U[0]);
              Z = angular.element('<canvas style="position:absolute;">'), J = Z[0].getContext("2d"), J.fillStyle = n.backgroundColor || "black", U.append(Z)
            }
            var r = v();
            Z[0].width = r.width, Z[0].height = r.height;
            for (var o, a = 0; e >= a; a++) o = Math.floor(r.width * (a / e)), J.fillRect(o - 1, 0, 2, r.height)
          }
        }

        function E() {
          Q = B[0].getBoundingClientRect()
        }
        ...
        function $(e) {
          if (!l[0].hasAttribute("disabled")) {
            var t;
            e.keyCode === o.KEY_CODE.LEFT_ARROW ? t = -z : e.keyCode === o.KEY_CODE.RIGHT_ARROW && (t = z), t && ((e.metaKey || e.ctrlKey || e.altKey) && (t *= 4), e.preventDefault(), e.stopPropagation(), c.$evalAsync(function() {
              M(s.$viewValue + t)
            }))
          }
        }
        ...
        function M(e) {
          s.$setViewValue(T(k(e)))
        }

        function A() {
          isNaN(s.$viewValue) && (s.$viewValue = s.$modelValue);
          var e = (s.$viewValue - W) / (X - W);
          c.modelValue = s.$viewValue, l.attr("aria-valuenow", s.$viewValue), w(e), L.text(s.$viewValue)
        }

        function T(e) {
          return angular.isNumber(e) ? Math.max(W, Math.min(X, e)) : void 0
        }
        ...
        function w(e) {
          V.css("width", 100 * e + "%"), q.css(o.CSS.TRANSFORM, "translate3d(" + 100 * e + "%,0,0)"), l.toggleClass("md-min", 0 === e)
        }
        ...
        function N(e) {
          j() || (et = !0, e.stopPropagation(), l.addClass("dragging"), H(e))
        }

        function x(e) {
          et && (e.stopPropagation(), H(e))
        }

        function _(e) {
          et && (e.stopPropagation(), et = !1)
        }

        function H(e) {
          tt ? D(e.pointer.x) : S(e.pointer.x)
        }
        ...
        var P = m.ngDisabled && d(m.ngDisabled),
          j = P ? function() {
            return P(c.$parent)
          } : angular.noop,
          F = angular.element(l[0].querySelector(".md-thumb")),
          L = angular.element(l[0].querySelector(".md-thumb-text")),
          q = F.parent(),
          B = angular.element(l[0].querySelector(".md-track-container")),
          V = angular.element(l[0].querySelector(".md-track-fill")),
          U = angular.element(l[0].querySelector(".md-track-ticks")),
          Y = r.throttle(E, 5e3);
        m.min ? m.$observe("min", f) : f(0), m.max ? m.$observe("max", p) : p(100), m.step ? m.$observe("step", h) : h(1);
        var K = angular.noop;
        m.ngDisabled && (K = c.$parent.$watch(m.ngDisabled, g)), n.expect(l, "aria-label"), i.register(l, "drag"), l.attr({
          tabIndex: 0,
          role: "slider"
        }).on("keydown", $).on("$md.pressdown", y).on("$md.pressup", C).on("$md.dragstart", N).on("$md.drag", x).on("$md.dragend", _), setTimeout(u);
        var G = e.throttle(u);
        angular.element(t).on("resize", G), c.$on("$destroy", function() {
          angular.element(t).off("resize", G), K()
        }), s.$render = A, s.$viewChangeListeners.push(A), s.$formatters.push(T), s.$formatters.push(k);
        var W, X, z, Z, J, Q = {};
        E();
        var et = !1,
          tt = angular.isDefined(m.mdDiscrete)
      }
      return {
        scope: {},
        require: "?ngModel",
    ...
    function e(e, t, n, r, o) {
      function a(e) {
        function n(e, t) {
          ...
          return f.items.push(n), s.parent().prepend(n.clone), u(),
            function() {
        ...
        function o() {
          ...
          for (var e, t = s.prop("scrollTop"), n = f.items.length - 1; n >= 0; n--)
            if (t > f.items[n].top) {
              e = f.items[n];
              break
            }
        ...
        function a(e) {
          var t = e.element[0];
          for (e.top = 0, e.left = 0; t && t !== s[0];) e.top += t.offsetTop, e.left += t.offsetLeft, t = t.offsetParent;
          e.height = e.element.prop("offsetHeight"), e.clone.css("margin-left", e.left + "px")
        }

        function i() {
          var e = s.prop("scrollTop"),
            t = e > (i.prevScrollTop || 0);
          i.prevScrollTop = e, 0 === e ? c(null) : t && f.next ? f.next.top - e <= 0 ? c(f.next) : f.current && (f.next.top - e <= f.next.height ? m(f.current, f.next.top - f.next.height - e) : m(f.current, null)) : !t && f.current && (e < f.current.top && c(f.prev), f.current && f.next && (e >= f.next.top - f.current.height ? m(f.current, f.next.top - e - f.current.height) : m(f.current, null)))
        }
        ...
        var s = e.$element,
          u = r.throttle(o);
        d(s), s.on("$scrollstart", u), s.on("$scroll", i);
        var f, p = s.prop("offsetTop");
        return f = {
          prev: null,
          current: null,
          next: null,
        ...
        compile: function(r, o, a) {
          ...
          return function(r, o) {
            ...
            n(o), a(r, function(e) {
              ...
              var c = t(angular.element(i))(r);
              n(c), d(c).append(a), e(r, o, c)
            })
          }
        }
      }
      ...
      function c(e, t) {
        ...
        return e.addClass("md-dragging"),
          function(e, t, c, l) {
            ...
            }), r(e, t, c, l), angular.isDefined(c.ngDisabled) && e.$watch(p, function(e) {
              t.attr("tabindex", e ? -1 : 0)
            }), d.register(g, "drag"), g.on("$md.dragstart", m).on("$md.drag", s).on("$md.dragend", u);
            var b
          }
      }
      var l = e[0];
      ...
      return {
        ...
        link: function(e, n, r, o) {
          ...
          if (o[0]) {
            ...
            }), n.attr("type", r.type || n.parent().attr("type") || "text"), d && d.$formatters.push(function(e) {
  ...
  function() {
    ...
    function t(e) {
      function t(e, t, n, r) {
        function o(n, o, a) {
          return o.addClass(a.position.split(" ").map(function(e) {
            return "md-" + e
          }).join(" ")), a.parent.addClass(i(a.position)), a.onSwipe = function(t) {
            o.addClass("md-" + t.type.replace("$md.", "")), e(r.cancel)
          }, o.on("$md.swipeleft $md.swiperight", a.onSwipe), t.enter(o, a.parent)
        }
      ...
      return t.$inject = ["$timeout", "$animate", "$mdTheming", "$mdToast"], e("$mdToast").setDefaults({
    ...
    function e(e, t, n, r) {
      return {
        ...
        link: function(o, a, i) {
          function d() {
            function r(t, n) {
              a.parent()[0] === n.parent()[0] && (m && m.off("scroll", p), n.on("scroll", p), n.attr("scroll-shrink", "true"), m = n, e(d))
            }

            function d() {
              l = a.prop("offsetHeight"), m.css("margin-top", -l * f + "px"), c()
            }

            function c(e) {
              var n = e ? e.target.scrollTop : u;
              h(), s = Math.min(l / f, Math.max(0, s + n - u)), a.css(t.CSS.TRANSFORM, "translate3d(0," + -s * f + "px,0)"), m.css(t.CSS.TRANSFORM, "translate3d(0," + (l - s) * f + "px,0)"), u = n
            }
            var l, m, s = 0,
              u = 0,
          ...
          r(a), angular.isDefined(i.mdScrollShrink) && d()
        }
      }
    }
      ...
      function d(d, m, s) {
        ...
        function f() {
          m.removeClass("md-hide"), g.attr("aria-describedby", m.attr("id")), E.append(m), h(), n(function() {
            n(function() {
              h(), d.visible && m.addClass("md-show")
            })
          })
        }
        ...
        angular.isDefined(s.mdDelay) || (d.delay = c), m.detach(), m.attr("role", "tooltip"), m.attr("id", s.id || "tooltip_" + o.nextUid()), g.on("focus mouseenter touchstart", function() {
          u(!0)
        }), g.on("blur mouseleave touchend touchcancel", function() {
          r[0].activeElement !== g[0] && u(!1)
        }), d.$watch("visible", function(e) {
          e ? f() : p()
        });
        var v = n.throttle(function() {
          d.visible && h()
        });
        angular.element(t).on("resize", v), d.$on("$destroy", function() {
          d.visible = !1, m.remove(), angular.element(t).off("resize", v)
        })
      }
      var c = 400,
        l = 8;
    ...
    function e(e) {
      function t(t, r, o, a) {
        function i() {
          ...
          if (r.css("display", o ? "none" : "block"), !o && t.pagination && t.pagination.tabData) {
            var a = c.getSelectedIndex(),
              ...
              m = ["md-transition-left", "md-transition-right", "md-no-transition"],
              s = n > a ? 0 : a > n ? 1 : 2;
            r.removeClass(m.join(" ")).addClass(m[s]).css({
              left: i.left + "px",
              right: l + "px"
            }), n = a
          }
        ...
        var d = !!a[0],
          c = a[1],
          l = e.throttle(i);
        c.inkBarElement = r, t.$on("$mdTabsPaginationChanged", l)
      }
      var n = 0;
      return {
        restrict: "E",
    ...
    function e(e, t, n, r, o, a) {
      function i(i, c, l, m) {
        function s(e, t) {
          if (e) {
            var n = b(e);
            T.active && n !== T.page ? (t && t.element.blur(), E(n).then(function() {
              A = !1, e.element.focus()
            })) : e.element.focus()
          }
        }
        ...
        function f() {
          ...
          function n() {
            return l || i.$watch(function() {
              o(function() {
                c[0].offsetParent && (angular.isFunction(l) && l(), $(), l = null)
              }, 0, !1)
            })
          }
          if (c.prop("offsetParent")) {
            ...
            t();
            var a = T.tabData = g(),
              d = T.active = a.pages.length > 1;
            d && e(), i.$evalAsync(function() {
        ...
        function g(e) {
          function t() {
            var e = 1 === s.length ? r : o,
              t = Math.min(Math.floor(e / l), v.length),
              n = Math.floor(e / t);
            return a.css("width", n + "px"), g(!0)
          }
          var n, r = c.parent().prop("offsetWidth"),
            o = r - d - 1,
            a = angular.element(v),
            i = 0,
            l = 0,
          ...
          return a.css("max-width", ""), angular.forEach(v, function(e, t) {
            ...
            d.page = Math.ceil(d.right / (1 === s.length && t === v.length - 1 ? r : o)) - 1, d.page >= s.length ? (d.filler = o * d.page - d.left, d.right += d.filler, d.left += d.filler, n = {
              left: d.left,
              firstTabIndex: t,
              lastTabIndex: t,
              tabs: [d]
            }, s.push(n)) : (n.lastTabIndex = t, n.tabs.push(d)), i = d.right, l = Math.max(l, a), m.push(d)
        ...
        var v = c[0].getElementsByTagName("md-tab"),
          $ = n.throttle(f),
          M = c.children(),
          A = !1,
          T = i.pagination = {
  ...
  function() {
    ...
    function e(e, t, n, r, o, a, i, d) {
      ...
      function l(t, n) {
        h.content.length && (h.contentContainer.append(h.content), h.contentScope = e.$parent.$new(), t.append(h.contentContainer), r(h.contentContainer)(h.contentScope), n === !0 && d(function() {
      ...
      function u(n) {
        a.reconnectScope(h.contentScope), t.addClass("active").attr({
          "aria-selected": !0,
          tabIndex: 0
        }).on("$md.swipeleft $md.swiperight", p), s(n), o.removeClass(h.contentContainer, "ng-hide"), e.onSelect()
      }
      ...
      function f(n) {
        a.disconnectScope(h.contentScope), t.removeClass("active").attr({
          "aria-selected": !1,
          tabIndex: -1
        }).off("$md.swipeleft $md.swiperight", p), s(n), o.addClass(h.contentContainer, "ng-hide"), e.onDeselect()
      }
      ...
      h.contentContainer = angular.element('<div class="md-tab-content ng-hide">'), h.element = t, h.isDisabled = c, h.onAdd = l, h.onRemove = m, h.onSelect = u, h.onDeselect = f;
  ...
  function() {
    ...
    function e(e, t, n, r, o) {
      function a(a, i) {
        var d = a.find("md-tab-label");
        d.length ? d.remove() : d = angular.isDefined(i.label) ? angular.element("<md-tab-label>").html(i.label) : angular.element("<md-tab-label>").append(a.contents().remove());
        var c = a.contents().remove();
        return function(a, i, l, m) {
          function s() {
            var e = d.clone();
            i.append(e), t(e)(a.$parent), E.content = c.clone()
          }

          function u() {
            a.$apply(function() {
              v.select(E), v.focus(E)
            })
          }
          ...
          function h() {
            function e(e) {
              var t = v.getSelectedItem() === E;
              e && !t ? v.select(E) : !e && t && v.deselect(E)
            }
          ...
          function g() {
            function e(e) {
              ...
              var t = v.getSelectedItem() === E;
              t && e && v.select(v.next() || v.previous())
            }
            a.$watch(E.isDisabled, e)
          }
          ...
          function b() {
            ...
            if (i.attr({
              ...
              var t = "content_" + e;
              i.attr("aria-controls") || i.attr("aria-controls", t), E.contentContainer.attr({
                id: t,
                role: "tabpanel",
                "aria-labelledby": e
              })
          ...
          o(i.addClass.bind(i, "md-tab-themed"), 0, !1), a.$watch(function() {
            ...
            o(function() {
              v.scope.$broadcast("$mdTabsChanged")
            }, 0, !1)
          }), s(), b();
          var $ = e.attachTabBehavior(a, i, {
            colorElement: v.inkBarElement
          });
          v.add(E), a.$on("$destroy", function() {
            $(), v.remove(E)
    ...
    function e(e, t, n) {
      ...
      function i(t, n) {
        if (p.contains(t) && !n) {
          var o = r() === t,
            a = u() || s();
          m(t), p.remove(t), t.onRemove(), e.$broadcast("$mdTabsChanged"), o && c(a)
        }
      }

      function d(t, n) {
        var o = r() === t;
        p.remove(t), p.add(t, n), o && c(t), e.$broadcast("$mdTabsChanged")
      }
      ...
      var g = (h.contentArea = angular.element(t[0].querySelector(".md-tabs-content")), h.inRange = p.inRange, h.indexOf = p.indexOf),
        b = h.itemAt = p.itemAt;
      h.count = p.count, h.getSelectedItem = r, h.getSelectedIndex = o, h.add = a, h.remove = i, h.move = d, h.select = c, h.focus = l, h.deselect = m, h.next = s, h.previous = u, e.$on("$destroy", function() {
        m(r());
  ...
  function() {
    ...
    function e(e) {
      function t(t, n, r, o, a) {
        ...
        t.stretchTabs = r.hasOwnProperty("mdStretchTabs") ? r.mdStretchTabs || "always" : "auto", e(n), i(), d(), a(t.$parent, function(e) {
